...
import com.idophin.log.LogUtil;
import com.idophin.log.LogUtilHelper;
...
public final class HttpLoggingInterceptorM implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        try {
            ...
            logger.log("<-- HTTP FAILED: " + e, LogUtil.E);
            throw e;
        }
        ...
        logger.log(requestStartMessage, LogUtil.E);
        ...
        logger.log("<-- " + response.code() + ' ' + response.message() + ' ' + response.request()
                .url() + " (" + tookMs + "ms" + (!logHeaders ? ", " + bodySize + " body" : "") + ')', LogUtil.E);
